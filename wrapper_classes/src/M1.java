...
//for every primitive data type there is corusponding wrapper class
...
//except in char wrapper class all remining wrapper class the are two constructor available.--
//one constructo can taking argument of same type
